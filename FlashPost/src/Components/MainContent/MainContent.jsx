...
function MainContent() {
  ...
  const fetchPersonalisedBlogs = async (page) => {
    try {
      // const response = await axios.get(`https://localhost/3000/api/blogs/blogsPage/${page}`);
  ...
  const fetchTrendingBlogs = async () => {
    try {
      // const response = await axios.get(`https://localhost/3000/api/blogs/trending`);
            ...
            <div className="m-4 px-4">
              {category === "personalised" && (
                <InfiniteScroll
                  ...
                  hasMore={more}
                  loader={
                    <h4 className="mx-10 px-10 mt-10 text-center animate-bounce">
                      Loading More Blogs...
                    </h4>
                  }
                  endMessage={
                    <p className="mx-10 px-10 mt-10 text-center text-secondary animate-pulse">
